...
class FixGenerator:
    ...
    def _define_tools(self) -> List[Dict]:
        ...
        return [
            {
                "name": "read_file",
                "description": "Read the contents of a file from the repository. Use this to examine source code, configuration files, or any other files that might be relevant to fixing the deployment failure.",
                "input_schema": {
                    "type": "object",
                    "properties": {
                        "file_path": {
    ...
    async def generate_fix(
        ...
        """Generate a fix for a deployment failure.
        ...
        system_prompt = """You are an expert DevOps engineer helping to fix deployment failures automatically.
...
3. Analyze the deployment failure logs and previous analysis
