...
[2025-12-15T12:00:45Z] npm ERR! While resolving: chartmetric-app@1.0.0
...
def send_coolify_webhook(
    ...
    payload = {
        ...
        "deployment": {
            ...
            "status": "failed",
            "application_id": "app-chartmetric-preview",
        ...
        "application": {
            "id": "app-chartmetric-preview",
            "name": "chartmetric-preview",
            "repository": {
                "url": "https://github.com/chartmetric/enterprise-fullstack-assignment",
                "branch": f"pr-{pr_number}",
                "full_name": "chartmetric/enterprise-fullstack-assignment",
            },
        },
        "pull_request": {
            "number": pr_number,
            "url": f"https://github.com/chartmetric/enterprise-fullstack-assignment/pull/{pr_number}",
        },
    }
