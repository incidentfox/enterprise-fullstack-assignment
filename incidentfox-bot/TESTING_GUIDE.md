...
def send_deployment_webhook(status: str, pr_number: int, logs: str):
    ...
    payload = {
        ...
        "application": {
            ...
            "repository": {
                "url": "https://github.com/chartmetric/enterprise-fullstack-assignment",
...
2. **Configure Coolify for the Chartmetric repo:**
...
If you want to demo IncidentFox to Eunhye or other stakeholders, use **Option 2** with this script:
...
backend:
  environment:
    # - DATABASE_URL=postgresql://postgres:password@db:5432/chartmetric  # ← Comment out
```
...
3. Onboard Chartmetric team
4. Iterate based on real failure patterns
5. Expand failure mode coverage
6. Add custom failure patterns specific to Chartmetric's stack
